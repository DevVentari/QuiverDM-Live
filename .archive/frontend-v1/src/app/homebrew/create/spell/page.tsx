...
import { useSpellForm } from '@/hooks/forms/useSpellForm';

export default function CreateSpellPage() {
  const router = useRouter();
  const { formData, updateField, submit, isSubmitting } = useSpellForm({
            ...
            <Grid columns="2" gap="3">
              <Box>
                ...
                <Select.Root
                  ...
                  onValueChange={(val) => updateField('saveType', val === 'none' ? '' : val)}
                >
                  <Select.Trigger />
                  <Select.Content>
              ...
              <Box>
                ...
                <Select.Root
                  value={formData.attackType || 'none'}
                  onValueChange={(val) => updateField('attackType', val === 'none' ? '' : val)}
                >
                  <Select.Trigger />
                  <Select.Content>
                    <Select.Item value="none">No attack roll</Select.Item>
