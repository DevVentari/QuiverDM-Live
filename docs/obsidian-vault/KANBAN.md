...
- [ ] **API Usage & Cost Page** — `/settings/api-usage` — per-provider summary cards (Gemini/OpenAI/Anthropic/Ollama), breakdown by feature and model, recent call log, period selector. Internal tracking via `ApiUsageLog` model + optional provider API sync. Refs: `docs/plans/2026-03-07-api-usage-cost-page-design.md`
