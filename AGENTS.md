...
Skills go in `.Codex/skills/<name>/SKILL.md` and are immediately available.

## Codex Delegation

Use the `codex-router` skill to decide what to delegate. Codex = architect/reviewer. Codex = pattern-following implementation.
