...
export function WhisperUpload() {
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      formData.append('sessionId', 'temp-session'); // TODO: Get from context
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled={uploading || transcribeMutation.isPending}
          ...
          <button
            ...
            disabled={!audioFile || !localFileUrl || transcribeMutation.isPending || uploading}
