  ...
  return (
    ...
    >
      {imageUrl ? (
        ...
        <div className="h-32 w-full bg-[linear-gradient(135deg,var(--q-accent-primary-trace),transparent_70%)]" />
      )}
      <div className="absolute inset-x-0 bottom-0 p-6 space-y-1">
        {overline && (
          <p className="font-[var(--q-font-display)] text-[10px] tracking-[2.5px] text-[var(--q-accent-primary)] uppercase">
            {overline}
          </p>
        )}
