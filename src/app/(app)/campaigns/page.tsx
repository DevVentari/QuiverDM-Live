...
function CampaignsPageInner() {
  ...
  function openSheet() { router.replace('?create=true'); }
  function closeSheet() { router.replace('/campaigns'); }
  ...
  const heroStats = [
    { label: totalCampaigns === 1 ? 'campaign' : 'campaigns', value: totalCampaigns },
  ...
  return (
    ...
    >
      <div className="flex gap-6 items-start">
        ...
        <div className="hidden lg:flex flex-col w-[200px] shrink-0 gap-4 lg:self-start lg:sticky lg:top-4">
                      ...
                      {campaign.bannerUrl ? (
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[hsl(240,15%,13%)] via-[hsl(250,20%,10%)] to-[hsl(35,30%,8%)]">
                          <div
                            ...
                            style={{ backgroundImage: 'radial-gradient(circle at 30% 50%, hsl(35,60%,40%), transparent 60%), radial-gradient(circle at 80% 20%, hsl(260,40%,30%), transparent 50%)' }}
                          />
                        </div>
                      )}
