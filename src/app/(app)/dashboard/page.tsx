...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      <div className="dashboard-bg space-y-6 overflow-hidden rounded-[1.1rem] border border-white/5 p-4 sm:p-5">
        {!campaigns.isLoading && campaigns.data && campaigns.data.length > 0 && (
          <div className="stone-card glass-panel">
            <div className="stone-card-body py-3 flex flex-wrap items-center gap-x-5 gap-y-2">
              ...
              <span className="hidden select-none text-border sm:block">·</span>
              <div className="flex items-center gap-2">
        ...
        <div className="space-y-3">
          ...
          {campaigns.isLoading ? (
            ...
            <div className="flex snap-x snap-mandatory gap-4 overflow-x-auto -mx-1 px-1 pb-2 scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent">
              {campaigns.data.map((campaign) => (
                ...
                >
                  <div className="stone-card glass-panel flex h-full cursor-pointer flex-col overflow-hidden transition-colors hover:border-amber-700/40">
                    {campaign.bannerUrl && (
                    ...
                    <div className="stone-card-header pb-2">
                      <div className="flex items-center justify-between gap-2">
                        <span className="truncate text-sm stone-card-title">{campaign.name}</span>
                      </div>
                    </div>
